...
# Date:  12/9/15
# Script Name:  LICOR TrialA
# Version: 1.0
#
# <brief description of script's function>
# Trying to find differences between treatment groups from Trial A in GC418 
...
data1=read.csv("~/Downloads/Trial_A_LICOR_R.csv",header=T)
...
ggplot(m82, aes(Treat, Photo, fill=Treat)) +
  ...
  ggtitle("M82 Mean Photosynthesis by Treatment: Trial A")+
